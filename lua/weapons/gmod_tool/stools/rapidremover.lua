...
if ( CLIENT ) then
	language.Add("tool.rapidremover.name", "Rapid Remover")
	language.Add("tool.rapidremover.desc", "Spam removes props")
	language.Add("Tool.rapidremover.0", "Click anywhere to spam remove objects")
end

TOOL.Name = "#tool.rapidremover.name"
...
function TOOL.BuildCPanel( CPanel )
	...
	CPanel:AddControl( "Header", { Description = "Rapid Remover" } )
