...
if ( CLIENT ) then
	language.Add("tool.balloonbonanza.name", "Balloon Bonanza")
	language.Add("tool.balloonbonanza.desc", "Spams balloons that explode instantly")
	language.Add("Tool.balloonbonanza.0", "Click anywhere to spam ballons")
end

TOOL.Name = "#tool.balloonbonanza.name"
...
function TOOL:LeftClick( trace, attach )
	...
	balloon:TakeDamage(balloon:Health(), ply,ply)
	return true
